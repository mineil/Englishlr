...
subsequent		a.随后的，后来的（sequent 接续而来的 subsequence	后继，随后	consequence  结果，后果）
...
induce		vt.诱引，劝使；引起，导致（reduce 减少 deduce vt.推测，推断   educe  引出，得出	seduce 诱使  induction n.归纳法，诱使；引起 		inductive		a.归纳的，诱人的）
